                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <div>
                                <h4 class="mb-sm-0 text-center">Customer Invoice</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <a href="{{ route('customer.credit.report') }}" class="btn btn-dark btn-rounded waves-effect waves-light mb-2" style="float:right;"><i class="fa fa-list"> Back </i></a>
                            <div class="row">
                                <div class="col-12">
                                    <div>
                                        <div class="p-2">
                                            ...
                                            <div class="">
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="no-line text-end"><h4 class="m-0">tk.{{ $payment->total_amount }}</h4></td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                </div>
                                                <div class="row">
                                                    <div class="form-group col-md-3">
                                                        ...
                                                        <input type="text" name="paid_amount" class="form-control mt-2 paid_amount" placeholder="Enter Paid Amount" style="display:none;">
                                                    </div>
                                                    <div class="form-group col-md-3">
                                                        <div class="md-3">
